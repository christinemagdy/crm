...
namespace Bebrand.Domain.Commands.Client
{
    ...
    {
        public RegisterNewClientCommand(string name_of_business, string Email,
            ...
            string Lastfeedback, string ServiceProvded, string Case, Guid AccountManger, Call call, Typeclient typeclient, string phoneone, string phonetwo)
        {
